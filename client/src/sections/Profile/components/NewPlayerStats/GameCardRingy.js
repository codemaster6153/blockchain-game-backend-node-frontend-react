...
function GameCardRingy({data, allTimeStats, thisWeekData}) {
    return (
        <div className='game-card ringy'>
            <div className='game-img'>
                <img src='/images/ringy-dingy_title.png' alt='candy' />
            </div>
            {
                !allTimeStats &&
