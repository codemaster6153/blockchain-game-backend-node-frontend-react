...
function GameCardCandy({data, allTimeStats, thisWeekData}) {
    return (
        <div className='game-card candy'>
            <div className='game-img'>
                <img src='/images/title_candy_fiesta.png' alt='candy' />
            </div>
            {
                !allTimeStats &&
