...
function GameCardEndless({data, allTimeStats, thisWeekData}) {
    return (
        <div className='game-card endless'>
            <div className='game-img'>
                <img src='/images/title_siege.png' alt='candy' />
            </div>
            {
                !allTimeStats &&
...
export default GameCardEndless