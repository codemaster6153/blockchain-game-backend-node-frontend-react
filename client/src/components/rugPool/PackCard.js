...
export default function PackCard({image, id, mint, type, asset_id, wax}) {
        ...
        if (currType === "land") {
            ...
            try {
                ...
                if (result) {
                    ...
                    setAssetId(id);
                    setType("land");
                    setImage("rug_pool_nft_" + asset.data.hall_id + ".jpg");
    ...
    return (
        <div className="pack-card">
            <div className="image">
                <div className="imgs">
                    <img src={`/images/empty_pack_rug_pool.png`} alt="land" className="bck-img" width="88%" />
                    <img src={`/images/${currImage}`} onLoad={imageLoaded} alt="pack-card" className="top-img" width="88%" />
                </div>
